...
from streamlit_webrtc.pqc import CPqc
...
def main():
	...
	with server_state_lock["pqc_pk"]:
		if "pqc_pk" not in server_state:
			server_state["pqc_pk"] = CPqc("FrodoKEM-640-AES")
	...
	self_ctx = webrtc_streamer(
		...
		audio_html_attrs=AudioHTMLAttributes(KEM=pqc.PUBLIC_KEY.hex()),
